...
**Inside this skill, do NOT run `git commit` directly for code changes** — the scripts below handle their own commits for `.trellis/` metadata. If code was committed by AI earlier, that still must have required explicit user confirmation before this skill.
